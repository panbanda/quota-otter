...
if(!/^quota-otter-v\d+\.\d+\.\d+$/.test(tag||'')||!['universal-apple-darwin','x86_64-pc-windows-msvc','x86_64-unknown-linux-gnu'].includes(target))throw Error('Invalid release input');
